...
const HomeSlider = () => {
  return (
    <Swiper
      className="h-40 md:h-96 w-11/12 max-w-8xl mx-auto"
    ...
    >
      ...
      <SwiperSlide className="relative">
        ...
        <div className="absolute z-30 top-10 left-10 md:top-1/2 md:left-1/2 md:transform md:-translate-x-1/2 md:-translate-y-1/2 hidden md:block">
          ...
          <p className="font-light text-gray-300 mt-5">
            ...
            collaborate with like-minded individuals to drive positive change in
            your community.
          </p>
        </div>
      </SwiperSlide>
      <SwiperSlide className="relative">
        ...
        <div className="absolute z-30 top-10 left-10 md:top-1/2 md:left-1/2 md:transform md:-translate-x-1/2 md:-translate-y-1/2 hidden md:block">
          ...
          <p className="font-light text-gray-300 mt-5">
            Every act of kindness counts. Sign up now to volunteer, post needs,
            or simply share your support. Together, we create a better world.
          </p>
        </div>
      </SwiperSlide>
    </Swiper>
